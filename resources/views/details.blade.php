...
<head>
  ...
  <style>
    body { font-family: 'Scheherazade New', serif; line-height: 1.6; }
    .banner {
    ...
    .breadcrumb-section { background: #f8f9fa; padding: 10px 0; }
    .section-title {
      margin-top: 40px;
      margin-bottom: 20px;
      padding-bottom: 10px;
    ...
    .instructor-img { width: 100px; height: 100px; object-fit: cover; border-radius: 50%; }
...
<body>
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <a class="navbar-brand" href="#">মদিনা অনলাইন মাদরাসা</a>
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item"><a class="nav-link" href="#featured-courses">কোর্স</a></li>
          <li class="nav-item"><a class="nav-link" href="#why-choose-us">কেন আমাদের</a></li>
          <li class="nav-item"><a class="nav-link" href="#events">ইভেন্ট</a></li>
          <li class="nav-item"><a class="nav-link" href="#testimonials">মন্তব্য</a></li>
    ...
    <div class="container">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0">
          ...
          <li class="breadcrumb-item"><a href="#">কোর্স</a></li>
          <li class="breadcrumb-item active" aria-current="page">আরবাইন কোর্স</li>
        </ol>
      </nav>
    </div>
  </section>
  ...
  <section class="banner d-flex align-items-center">
    <div class="container text-center banner-content">
      ...
      <p class="lead">আল্লাহর নামে, আরবি ভাষার মাধুর্য ও রহস্য উদঘাটনের এক অনন্য যাত্রা</p>
    </div>
  </section>
        ...
        <div class="col-lg-8">
            ...
            <div id="reviewCarousel" class="carousel slide" data-bs-ride="carousel">
              <div class="carousel-inner">
                <div class="carousel-item active">
                  <p class="lead text-center">"এই কোর্সের মাধ্যমে আমার আরবী ভাষার প্রতি ভালোবাসা ও শ্রদ্ধা আরও বেড়েছে।"</p>
                  <h6 class="text-center">- রফিকুল ইসলাম</h6>
                </div>
                <div class="carousel-item">
                  <p class="lead text-center">"প্রতিটি পাঠ যেন এক নতুন দিগন্তের উন্মোচন; সত্যিই অনন্য।"</p>
          ...
          <div class="mt-4">
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb-3">
                <div class="card">
                  <img src="https://via.placeholder.com/350x200" class="card-img-top" alt="আরবী উচ্চারণ">
                  <div class="card-body">
            ...
            <div class="accordion" id="faqAccordion">
              ...
              <div class="accordion-item">
                ...
                <div id="faqCollapse2" class="accordion-collapse collapse" data-bs-parent="#faqAccordion">
                  <div class="accordion-body">
                    সময়কাল ১৮ মাস এবং ফি ৫,০০০ টাকা – যাতে শিক্ষার্থীরা পর্যাপ্ত সময় নিয়ে গভীরভাবে শিখতে পারেন।
                  </div>
                </div>
              </div>
              <div class="accordion-item">
              ...
              <div class="col-md-4 mb-3">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text">অনলাইন শিক্ষায় নেতৃস্থানীয় ব্যক্তিত্ব হিসেবে নিজেকে প্রতিষ্ঠিত করেছেন।</p>
                  </div>
                </div>
              </div>
              <div class="col-md-4 mb-3">
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p class="card-text">আধুনিক প্রযুক্তি ও ইসলামী ঐতিহ্যের মিলনে শিক্ষা পরিবর্তনের নতুন দিগন্ত।</p>
    ...
    <div class="container">
      <div class="row align-items-center">
        <div class="col-md-6">
          ...
          <p class="mt-3">মদিনা অনলাইন মাদরাসা একটি আধুনিক, ব্যবহারকারী-বান্ধব প্ল্যাটফর্ম যা ইসলামী শিক্ষা প্রদান করে। আমরা বিশ্বাস করি সঠিক শিক্ষা ও মূল্যবোধের মাধ্যমে সমাজে ইতিবাচক পরিবর্তন আনা সম্ভব।</p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4 mb-4">
          ...
          <p>আল্লাহর নামে শিক্ষা ও জ্ঞানের আলো ছড়িয়ে দিতে আমরা নিবেদিত।</p>
        </div>
        <div class="col-md-4 mb-4">
          <h5>দ্রুত লিঙ্ক</h5>
          <ul class="list-unstyled">
            <li><a href="#" class="text-white text-decoration-none">হোম</a></li>
            <li><a href="#courses" class="text-white text-decoration-none">কোর্স</a></li>
            <li><a href="#about" class="text-white text-decoration-none">আমাদের সম্পর্কে</a></li>
            <li><a href="#contact" class="text-white text-decoration-none">যোগাযোগ</a></li>
          </ul>
        </div>
        <div class="col-md-4 mb-4">
          <h5>যোগাযোগ</h5>
      ...
      <div class="row mt-4">
        <div class="col text-center">
          ...
          <p class="mb-0">
            <a href="#" class="text-white text-decoration-none">প্রাইভেসি পলিসি</a> | 
            <a href="#" class="text-white text-decoration-none">টার্মস অব সার্ভিস</a>
          </p>
        </div>
      </div>
    </div>
  ...
  <script>
    ...
    mm.add("(max-width: 767px)", () => {
      gsap.from(".hero h1", { duration: 1.5, y: -30, opacity: 0, ease: "power3.out" });
      gsap.from(".hero p", { duration: 1.5, y: 30, opacity: 0, ease: "power3.out", delay: 0.5 });
      gsap.from(".featured-courses .card", { duration: 1, opacity: 0, y: 30, stagger: 0.2, delay: 1 });
      gsap.from("#why-choose-us .col", { duration: 1, opacity: 0, y: 30, stagger: 0.2, delay: 1.5 });
      gsap.from("#events .card", { duration: 1, opacity: 0, y: 30, stagger: 0.2, delay: 2 });
      gsap.from("#testimonials .carousel-item", { duration: 1, opacity: 0, y: 30, stagger: 0.3, delay: 2.5 });
      gsap.from("#faq .accordion-item", { duration: 1, opacity: 0, y: 30, stagger: 0.2, delay: 3 });
      gsap.from("#about h2", { duration: 1, x: -30, opacity: 0, delay: 3.5 });
      gsap.from("#contact h2", { duration: 1, x: 30, opacity: 0, delay: 4 });
    });
    
    // Desktop devices (min-width: 768px)
    mm.add("(min-width: 768px)", () => {
      gsap.from(".hero h1", { duration: 1.5, y: -50, opacity: 0, ease: "power3.out" });
      gsap.from(".hero p", { duration: 1.5, y: 50, opacity: 0, ease: "power3.out", delay: 0.5 });
      gsap.from(".featured-courses .card", { duration: 1, opacity: 0, y: 50, stagger: 0.2, delay: 1 });
      gsap.from("#why-choose-us .col", { duration: 1, opacity: 0, y: 50, stagger: 0.2, delay: 1.5 });
      gsap.from("#events .card", { duration: 1, opacity: 0, y: 50, stagger: 0.2, delay: 2 });
      gsap.from("#testimonials .carousel-item", { duration: 1, opacity: 0, y: 50, stagger: 0.3, delay: 2.5 });
      gsap.from("#faq .accordion-item", { duration: 1, opacity: 0, y: 50, stagger: 0.2, delay: 3 });
      gsap.from("#about h2", { duration: 1, x: -50, opacity: 0, delay: 3.5 });
      gsap.from("#contact h2", { duration: 1, x: 50, opacity: 0, delay: 4 });
    });
  </script>

...
<head>
  ...
  <style>
    body { 
      ...
      cursor: default;
      background-color: #f2f9f1; /* A soft, light background */
    }
  ...
  .footer-bottom {
    ...
    #contact {
    background: linear-gradient(to right, #f2f9f1, #e6f7e6); /* Soft, fresh gradient */
    padding: 4rem 0;
  }
  #contact h2 {
...
<body>
  ...
  <section class="hero d-flex align-items-center justify-content-center">
    <div class="container text-center hero-content">
      <h1 class="display-4">ইসলামী জ্ঞানর মুক্ত প্ল্যাটফর্ম: সহজ, সবার জন্য, সর্বত্র</h1>
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100">
            <img src="https://via.placeholder.com/400x250" class="card-img-top" alt="আিলম কোর্স">
            <div class="card-body">
              <h5 class="card-title">আিলম কোর্স</h5>
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100">
            <img src="https://via.placeholder.com/400x250" class="card-img-top" alt="আরব ভাষা কোর্স">
            <div class="card-body">
              <h5 class="card-title">আরব ভাষা কোর্স</h5>
              <p class="card-text">১৮ মাসের সুনির্দিষ্ট কোর্স</p>
              <p class="card-text">এই কোর্সে আরবি ভাষার মৌলিক ব্যাকরণ, উচ্চারণ ও কথ্য প্রয়োগ শেখানো হবে।</p>
              <ul class="list-unstyled">
                <li>সময়: ১৮ মাস</li>
                <li>ফি: ৫,০০০ টাকা</li>
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100">
            <img src="https://via.placeholder.com/400x250" class="card-img-top" alt="কুরআন শিক্ষা">
            <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100 text-center">
            <img src="https://avatar.iran.liara.run/public/boy" class="card-img-top rounded-circle mx-auto mt-3" style="width:150px; height:150px;" alt="আবদুল্লাহ হোসেন">
            <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100 text-center">
            <img src="https://avatar.iran.liara.run/public/boy" class="card-img-top rounded-circle mx-auto mt-3" style="width:150px; height:150px;" alt="মুহাম্মদ ইসলাম">
            <div class="card-body">
        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100 text-center">
            <img src="https://avatar.iran.liara.run/public/boy" class="card-img-top rounded-circle mx-auto mt-3" style="width:150px; height:150px;" alt="শায়খ আব্দুল করিম">
            <div class="card-body">
  ...
  <section id="why-choose-us" class="py-5">
    <div class="container">
      <div class="row text-center">
        <div class="col-md-4 mb-4">
          <div class="mb-3">
            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#004d40" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <section id="events" class="py-5">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-4 mb-4">
          <div class="card h-100">
            <img src="https://via.placeholder.com/400x250" class="card-img-top" alt="ইভেন্ট">
            <div class="card-body">
  ...
  <script>
    ...
    mm.add("(max-width: 767px)", () => {
      ...
      gsap.from("#teachers .card", { duration: 1, opacity: 0, y: 30, stagger: 0.2, delay: 1.3 });
      gsap.from("#why-choose-us .col", { duration: 1, opacity: 0, y: 30, stagger: 0.2, delay: 1.8 });
      gsap.from("#donation .card", { duration: 1, opacity: 0, y: 30, stagger: 0.2, delay: 2.3 });
      gsap.from("#events .card", { duration: 1, opacity: 0, y: 30, stagger: 0.2, delay: 2.8 });
      gsap.from("#testimonials .carousel-item", { duration: 0.5, opacity: 0, y: 30, stagger: 0.3, delay: 1.5 });
      gsap.from("#faq .accordion-item", { duration: 1, opacity: 0, y: 30, stagger: 0.2, delay: 3.8 });
      gsap.from("#about h2", { duration: 1, x: -30, opacity: 0, delay: 4.3 });
      gsap.from("#contact h2", { duration: 1, x: 30, opacity: 0, delay: 4.8 });
    });
    mm.add("(min-width: 768px)", () => {
      ...
      gsap.from("#teachers .card", { duration: 1, opacity: 0, y: 50, stagger: 0.2, delay: 1.3 });
      gsap.from("#why-choose-us .col", { duration: 1, opacity: 0, y: 50, stagger: 0.2, delay: 1.8 });
      gsap.from("#donation .card", { duration: 1, opacity: 0, y: 50, stagger: 0.2, delay: 2.3 });
      gsap.from("#events .card", { duration: 1, opacity: 0, y: 50, stagger: 0.2, delay: 2.8 });
      gsap.from("#testimonials .carousel-item", { duration: 1, opacity: 0, y: 50, stagger: 0.3, delay: 3.3 });
      gsap.from("#faq .accordion-item", { duration: 1, opacity: 0, y: 50, stagger: 0.2, delay: 3.8 });
      gsap.from("#about h2", { duration: 1, x: -50, opacity: 0, delay: 4.3 });
      gsap.from("#contact h2", { duration: 1, x: 50, opacity: 0, delay: 4.8 });
    });
  </script>
  <script>
